...
public class TemperatureDistribution extends Configured implements Tool {
    ...
    static class TemperatureCountMapper extends Mapper<LongWritable, Text, IntWritable, LongWritable> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (parser.isValidTemperature()) {
                context.write(new IntWritable(parser.getAirTemperature()), ONE);
            }
        }
    }
